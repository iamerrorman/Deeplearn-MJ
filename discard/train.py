import os
from data_set import Dataset_discard
...
# 获取数据集
ds_train = Dataset_discard("D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\discard", "train", action_to_id)
data_train = DataLoader(ds_train, batch_size=100)
ds_vel = Dataset_discard("D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\discard", "test", action_to_id)
data_vel = DataLoader(ds_vel, batch_size=100)
# 构建网络
my_model = Model_v1(71, 34)
...
for i in range(EPOCH):
    ...
    with torch.no_grad():
        ...
        torch.save(my_model.state_dict(), os.path.join("D:\\project\\python\\MJDecisionAI-DeepLearn\\discard"
