...
class Dataset_discard(Dataset):
    def __init__(self, root, mode, action_dict):
        super(Dataset_discard, self).__init__()
        self.root = root
        ...
        for item in file_names:
            ...
            temp = temp[: int(len(temp) * 0.5)]  # 就取一半来训练，另一半用来测试
...
if __name__ == '__main__':
    root = "D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\discard"
    ds_train = Dataset_discard(root, "train", action_to_id)
