...
class Dataset_peng(Dataset):
    def __init__(self, root, mode, action_dict):
        super(Dataset_peng, self).__init__()
        self.root = root
        ...
        for item in file_names:
            ...
            temp = temp[: int(len(temp) * 0.8)]  # pass就取一半来训练，另一半用来测试
...
if __name__ == '__main__':
    root = "D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\peng"
    ds_train = Dataset_peng(root, "train", action_to_id)
