import os
from data_set import Dataset_hu
...
# 获取数据集
ds_train = Dataset_hu("D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\hu", "train", action_to_id)
data_train = DataLoader(ds_train, batch_size=100)
ds_vel = Dataset_hu("D:\\project\\python\\MJDecisionAI-DeepLearn\\data\\output\\hu", "test", action_to_id)
data_vel = DataLoader(ds_vel, batch_size=100)
# 构建网络
my_model = Model_v1(71, 2)
my_model.load_state_dict(torch.load("D:\\project\\python\\MJDecisionAI-DeepLearn\\hu\\mode_param\\ep14_acc=0.7283.pth"))
my_model.to(device)
...
for i in range(23, EPOCH):
    ...
    with torch.no_grad():
        ...
        torch.save(my_model.state_dict(), os.path.join("D:\\project\\python\\MJDecisionAI-DeepLearn\\hu"
